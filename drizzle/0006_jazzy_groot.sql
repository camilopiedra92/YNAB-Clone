...
CREATE UNIQUE INDEX "transfers_from_tx_unique" ON "transfers" USING btree ("from_transaction_id");--> statement-breakpoint
CREATE UNIQUE INDEX "transfers_to_tx_unique" ON "transfers" USING btree ("to_transaction_id");