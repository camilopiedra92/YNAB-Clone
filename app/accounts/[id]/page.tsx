...
export default function AccountDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const { data: transactions = [], isLoading: loadingTransactions, isFetching: isFetchingTransactions } = useTransactions(accountId);
    ...
    const handleOpenReconcile = useCallback(async () => {
        reconciliationInfoMutation.mutate(accountId, {
            onSuccess: (info) => {
    ...
    }, [accountId, reconciliationInfoMutation]);
    ...
    }, [bankBalanceInput, accountId, reconcileAccountMutation]);
