    ...
    const onDragEnd = async (event: DragEndEvent) => {
        ...
        if (active.data.current?.type === 'group') {
            ...
            if (oldIndex !== -1 && newIndex !== -1) {
                ...
                queryClient.setQueryData(['budget', budgetId, currentMonth], (old: any) => ({ ...old, budget: newBudgetData }));
        ...
        <AppLayout>
            <div className="flex flex-col h-full">
                ...
                <div className="px-8 py-2.5 flex items-center justify-between bg-background">
                    <div className="flex items-center gap-4">
                        <CreateCategoryGroupPopover budgetId={budgetId!} onSuccess={() => fetchBudget()} />
                    </div>
